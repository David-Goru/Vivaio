...
public class Products : MonoBehaviour
{
    ...
    public void GetProducts()
    {
        ...
        {
            ProductsList.Add(new Product(product["Name"].InnerText, product["Type"].InnerText, Resources.Load<Sprite>("Crops/" + product["Name"].InnerText), int.Parse(product["MediumValue"].InnerText)));
        }
    }
}